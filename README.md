# VYNE SaaS — AI Readiness Diagnostic Platform

## Documentation

| Document | For whom |
|---|---|
| [docs/USER_GUIDE.md](docs/USER_GUIDE.md) | Consultants running a diagnostic, start to deck |
| [docs/OPERATIONS_RUNBOOK.md](docs/OPERATIONS_RUNBOOK.md) | Deploy, migrate, preflight, backups, rollback |
| [docs/AUDIT_BRIEFING.md](docs/AUDIT_BRIEFING.md) | A third-party security auditor's day one |
| [SECURITY.md](SECURITY.md) | The security model, and its known weaknesses |
| [BACKUP_RESTORE_RUNBOOK.md](BACKUP_RESTORE_RUNBOOK.md) | Rehearsing a restore |
| [WHITE_LABEL_RUNBOOK.md](WHITE_LABEL_RUNBOOK.md) | Standing up a new firm |
